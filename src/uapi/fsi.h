...
#define FSI_SCOM_GET_INTERRUPT	_IOR('s', 0x04, __u32)
...
#define FSI_MBOX_RMW	_IOW('s', 0x01, struct mbox_access_rmw)
#define FSI_MBOX_WRITE	_IOW('s', 0x02, struct mbox_access)
